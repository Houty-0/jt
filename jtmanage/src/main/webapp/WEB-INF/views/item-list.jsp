...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <%--<th data-options="field:'catName',width:100,align:'center',formatter:KindEditorUtil.findItemCatName">叶子类目</th>--%>
            <th data-options="field:'catName',width:100,align:'center'">叶子类目</th>
